...
//客户端ID
//密钥
#define ClientId        @"ba357c74d442898656bc5ed090b12b6c"         //客户端ID
#define ClientSecret    @"a24ac7aed5de7c81ca52d561729dc9b3"         //密钥
#define AESKEY          @"b6a89174d1d050305265026357203708"         //AES密钥
...
#define APIURL              @"http://edsapi.tunneltest.edsmall.cn"
#endif

#ifdef testingEnvironment
#define APIURL              "http://114.215.177.79:9600"
#endif
...
#pragma mark - 个人信息
//随心配方案保存
#define APISXPSave                 [APIURL stringByAppendingString:@"/v1/scheme/add"]
//随心配图片上传
#define APISXPImageUpLoad                 [APIURL stringByAppendingString:@"/v1/scheme/upload"]
//浏览记录
#define APIBrowseList              [APIURL stringByAppendingString:@"/v1/record/list"]



//场景列表所需参数如空间、风格、类型等
#define APISXPSceneParam                 [APIURL stringByAppendingString:@"/v1/scene/tab/"]

//随心配方案列表
#define APISXPSchemeList                [APIURL stringByAppendingString:@"/v1/scheme/list"]

//判断手机号码是否是已注册账号
#define APISXPPhoneRegist                [APIURL stringByAppendingString:@"/v1/user/verifyMobile"]

//获取验证码
#define APIGetMobileCode              [APIURL stringByAppendingString:@"/v1/send/sendCode"]

//验证码获取AuthorizationCode(获取权限码)
#define APIPhoneGetAuthorizationCode              [APIURL stringByAppendingString:@"/v1/oauth2/mobileAuth"]
